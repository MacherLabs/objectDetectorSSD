...
MODEL_URLS=['http://api.staging.vedalabs.in/filemanager/7VLnJ/mobilenet_512_frozen_inference_graph_face.pb',
            'http://api.staging.vedalabs.in/filemanager/LiY86/mobilenet_300_frozen_inference_graph_face.pb']
...
class ObjectDetectorSSD():
    ...
    def __init__(self,model_name=None,precision ='FP32',input_size=300,threshold=0.3,gpu_frac=0,trt_enable=False,classes=['person']):
        ...
        if model_name==None:
            model_name='mobilenet_{}_frozen_inference_graph_face.pb'.format(input_size)
